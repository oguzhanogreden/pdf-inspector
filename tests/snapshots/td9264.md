...
||subject to tax under section 801 or section 831 also apply to foreign insurance|
||companies subject to tax under those sections, except that the copy of the annual|
||statement required to be submitted with the return shall, in the case of a foreign|
||insurance company that is not required to file an annual statement, be a copy of the|
||pro forma annual statement relating to the United States business of such company.|
...
||(c)(3) of this section files its Federal income tax return electronically, it should not|
||include on or with such return its annual statement (or pro forma annual statement),|
||or any portion thereof. Such statement must be available at all times for inspection|
||by authorized Internal Revenue Service officers or employees and retained for so|
||long as such statements may be material in the administration of any internal|
||revenue law. See §1.6001-1(e).|
||(5) Definition. For purposes of this section, the term annual statement means|
||the annual statement, the form of which is approved by the National Association of|
||Insurance Commissioners (NAIC), which is filed by an insurance company for the|
||year with the insurance departments of States, Territories, and the District of|
